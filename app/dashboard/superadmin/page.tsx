...
export default function SuperAdminPage() {
  ...
  const filteredStores = stores.filter((store) => {
    ...
    // Filtro por estado
    const matchesStatus =
      statusFilter === "all" || store.subscription_status === statusFilter;
  ...
  const totalWithTrial = stores.filter(
    (s) =>
  ...
  const conversionRate =
    totalWithTrial > 0
      ? ((activeStores / totalWithTrial) * 100).toFixed(1)
      : "0.0";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <CardContent>
            ...
            <p className="text-xs text-black mt-1">Suscripciones pagando</p>
        ...
        <Card className="hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-xs text-black mt-1">Trial → Activo</p>
            <div className="flex items-center mt-2 text-xs text-gray-600">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-xs text-black mt-1">Tiendas con actividad</p>
            <div className="flex items-center mt-2 text-xs text-gray-600">
              <span className="text-green-600">
                {totalStores > 0
                  ? ((storesUsingPOS / totalStores) * 100).toFixed(1)
                  : 0}
                % del total
              </span>
            </div>
        ...
        <Card className="hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-xs text-black mt-1">No han usado el POS</p>
            <div className="flex items-center mt-2 text-xs text-gray-600">
        ...
        <Card className="hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-xs text-black mt-1">Tiendas activas</p>
            <div className="flex items-center mt-2 text-xs text-gray-600">
              <span className="text-purple-600">
                De {totalStores} registradas
              </span>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <CardContent>
            ...
            <p className="text-xs text-black mt-1">Potenciales clientes</p>
        ...
        <Card className="cursor-pointer hover:shadow-lg transition-shadow group">
          ...
          <CardContent>
            ...
            <p className="text-xs text-black mt-1">Requieren atención</p>
                      ...
                      <tr key={store.id} className="border-b hover:bg-gray-50">
                        <td className="p-4">
                          <div className="font-medium">
                            {store.full_name || "Sin nombre"}
                          </div>
                          <div className="text-sm text-black">{store.role}</div>
                        </td>
                        ...
                        <td className="p-4">
                          <div className="flex gap-2 justify-end flex-wrap">
                            <Button
                              ...
                              variant="ghost"
                              onClick={() =>
                                setDetailsDialog({ open: true, store })
                              }
                              title="Ver detalles"
                            >
      ...
      <Dialog
        ...
        onOpenChange={(open) =>
          setExtendTrialDialog({ ...extendTrialDialog, open })
        }
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Extender el período de prueba para{" "}
              {extendTrialDialog.store?.full_name ||
                extendTrialDialog.store?.email}
            </DialogDescription>
          </DialogHeader>
            ...
            {extendTrialDialog.store && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 space-y-1">
                <div className="text-sm">
                  ...
                  {extendTrialDialog.store.subscription_status === "trial"
                    ? "En prueba"
                    : "No activo"}
                </div>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleExtendTrial}>Extender Trial</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
        ...
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {detailsDialog.store?.full_name || detailsDialog.store?.email}
            </DialogDescription>
          </DialogHeader>
          {detailsDialog.store && (
            <div className="space-y-4 py-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <p className="text-sm">
                    {detailsDialog.store.full_name || "No especificado"}
                  </p>
                </div>
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm">
                    {detailsDialog.store.phone || "No especificado"}
                  </p>
                </div>
                <div className="space-y-1">
                  <p className="text-sm font-medium text-black">Rol</p>
                  <p className="text-sm capitalize">
                    {detailsDialog.store.role}
                  </p>
                </div>
              </div>
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <p className="text-sm font-medium text-black">Estado</p>
                    <p className="text-sm capitalize">
                      {detailsDialog.store.subscription_status}
                    </p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm font-medium text-black">Plan</p>
                    <p className="text-sm">
                      {detailsDialog.store.plan_id || "Sin plan"}
                    </p>
                  </div>
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm">
                      {detailsDialog.store.has_ai_addon ? "Activo" : "Inactivo"}
                    </p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm font-medium text-black">
                    ...
                    <p className="text-sm">
                      {detailsDialog.store.auto_reports_enabled
                        ? "Activados"
                        : "Desactivados"}
                    </p>
                  </div>
