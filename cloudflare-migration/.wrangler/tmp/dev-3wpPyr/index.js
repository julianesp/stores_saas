...
// .wrangler/tmp/bundle-dmFCeD/checked-fetch.js
...
// .wrangler/tmp/bundle-dmFCeD/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-dmFCeD/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
app21.route("/api/webhooks", webhooks_default);
app21.post("/api/wompi/webhook", wompi_default);
app21.post("/api/subscriptions/webhook", subscriptions_default);
app21.route("/api/storefront", storefront_default);
app21.route("/stats", stats_default);
...
app21.post("/api/email/daily-reports", emailCronHandler);
app21.post("/api/email/subscription-reminders", emailCronHandler);
app21.post("/api/email/stock-alerts", emailCronHandler);
app21.post("/api/email/abandoned-carts", emailCronHandler);
app21.use("/api/*", authMiddleware);
app21.route("/api/wompi", wompi_default);
app21.route("/api/subscriptions", subscriptions_default);
app21.route("/api/products", products_default);
app21.route("/api/customers", customers_default);
app21.route("/api/sales", sales_default);
app21.route("/api/categories", categories_default);
app21.route("/api/suppliers", suppliers_default);
app21.route("/api/purchase-orders", purchase_orders_default);
app21.route("/api/debtors", debtors_default);
app21.route("/api/user-profiles", user_profiles_default);
app21.route("/api/credit-payments", credit_payments_default);
app21.route("/api/offers", offers_default);
app21.route("/api/payment-transactions", payment_transactions_default);
app21.route("/api/shipping-zones", shipping_zones_default);
app21.route("/api/admin", admin_stats_default);
app21.route("/api/email", email_default);
app21.route("/loyalty-settings", loyalty_settings_default);
app21.notFound((c) => {
  return c.json({
    success: false,
    error: "Not Found",
...
async function scheduled(event, env, ctx) {
  ...
  const makeRequest = /* @__PURE__ */ __name(async (path) => {
    try {
      ...
      const response = await app21.fetch(request, env, ctx);
