-- ============================================================
-- TIENDA POS - CLOUDFLARE D1 SCHEMA
-- Una instancia de esta base de datos por cada tienda/tenant
-- ============================================================

-- User Profile (información del dueño de la tienda)
...
CREATE TABLE IF NOT EXISTS products (
  ...
  image_url TEXT, -- Deprecated, mantener por compatibilidad
...
CREATE TABLE IF NOT EXISTS inventory_movements (
  ...
  new_stock INTEGER,
  reason TEXT,
  reference_type TEXT, -- 'venta', 'compra', 'ajuste'
  reference_id TEXT,
  notes TEXT,
  user_id TEXT,
  created_at TEXT NOT NULL DEFAULT (datetime('now')),
...
-- Shopping Carts (si se usa en el futuro)
...
-- Payment Transactions (suscripciones Wompi)
...
CREATE TABLE IF NOT EXISTS loyalty_settings (
  ...
  tiers TEXT NOT NULL, -- JSON array de LoyaltyTier
  created_at TEXT NOT NULL DEFAULT (datetime('now')),
  updated_at TEXT NOT NULL DEFAULT (datetime('now')),
...
-- Vista de ventas con cliente y cajero
...
-- Se pueden insertar categorías por defecto aquí si se desea
-- INSERT INTO categories (id, name, description) VALUES
-- ('cat-1', 'General', 'Categoría general'),
-- ('cat-2', 'Bebidas', 'Bebidas y líquidos'),
-- ('cat-3', 'Alimentos', 'Productos alimenticios');
